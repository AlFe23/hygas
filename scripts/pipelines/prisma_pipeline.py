...
def ch4_detection(
    ...
    bbox = prisma_utils.prismaL2C_bbox_read(L2C_file)
    ...
    (
        ...
        latitude_swir,
        longitude_swir,
    ) = prisma_utils.prisma_read(L1_file)
    logger.info(
    ...
    prisma_utils.save_as_geotiff_single_band(concentration_map, concentration_output_file, latitude_vnir, longitude_vnir)
    ...
    prisma_utils.save_as_geotiff_single_band(classified_image, classified_output_file, latitude_vnir, longitude_vnir)
